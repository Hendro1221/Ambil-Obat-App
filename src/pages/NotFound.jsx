...
const getImageUrl = (gambarPath, namaObat) => {
  if (!gambarPath) {
    return `https://placehold.co/400x400/4361ee/white?text=${encodeURIComponent(namaObat || 'Obat')}`;
  }
    ...
    return (
      <div className="container">
        <div className="loading-state">
          <div className="skeleton-image" style={{ width: '280px', margin: '0 auto' }}></div>
          <p>Memuat detail obat...</p>
        </div>
      </div>
    );
  }
      ...
      >
        <div className="detail-image-box">
          <motion.img
            ...
            onError={(e) => {
              e.target.src = `https://placehold.co/400x400/4361ee/white?text=${encodeURIComponent(obat.nama)}`;
            }}
          />
        ...
        <div className="detail-info">
          ...
          <div className="detail-meta">
            <span className="meta-item">📂 <strong>Kategori</strong><br/>{obat.kategori || 'Obat Umum'}</span>
            <span className="meta-item">📦 <strong>Status</strong><br/>{obat.stok > 0 ? 'Tersedia' : 'Habis'}</span>
          </div>
          ...
          {obat.stok > 0 && (
            <>
              <div className="quantity-section">
                ...
                <span style={{ fontSize: '0.85rem', color: 'var(--gray)' }}>Maksimal {obat.stok} item</span>
              </div>

              <div className="action-buttons">
                <motion.button 
                  className={`button success ${added ? 'success' : ''}`}
                  onClick={addToCart}
